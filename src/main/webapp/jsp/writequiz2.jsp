...
<body>
	Quiz ID Entered : <c:out value="${quiz.id}"></c:out>
	Marks Per Question :<c:out value="${quiz.marksPerQuestion}"></c:out>
	...
	<form action="/quiz/checkanswers/${quizid}" method ="post">
	...
	<br> <br> <a href="/user/clientwelcomepage"><button>Back</button></a>
	<br>
